...
namespace sogen::py
{
    namespace
    {
        ...
        constexpr std::array callback_slots{
            callback_slot{.name = "module_load", .member = &callback_registry::module_load_cb},
            callback_slot{.name = "module_unload", .member = &callback_registry::module_unload_cb},
            callback_slot{.name = "stdout", .member = &callback_registry::stdout_cb},
            callback_slot{.name = "syscall", .member = &callback_registry::syscall_cb},
            callback_slot{.name = "generic_access", .member = &callback_registry::generic_access_cb},
            callback_slot{.name = "generic_activity", .member = &callback_registry::generic_activity_cb},
            callback_slot{.name = "suspicious_activity", .member = &callback_registry::suspicious_activity_cb},
            callback_slot{.name = "exception", .member = &callback_registry::exception_cb},
            callback_slot{.name = "instruction", .member = &callback_registry::instruction_cb},
            callback_slot{.name = "memory_protect", .member = &callback_registry::memory_protect_cb},
            callback_slot{.name = "memory_allocate", .member = &callback_registry::memory_allocate_cb},
            callback_slot{.name = "memory_violate", .member = &callback_registry::memory_violate_cb},
            callback_slot{.name = "rdtsc", .member = &callback_registry::rdtsc_cb},
            callback_slot{.name = "rdtscp", .member = &callback_registry::rdtscp_cb},
            callback_slot{.name = "ioctrl", .member = &callback_registry::ioctrl_cb},
            callback_slot{.name = "debug_string", .member = &callback_registry::debug_string_cb},
            callback_slot{.name = "thread_create", .member = &callback_registry::thread_create_cb},
            callback_slot{.name = "thread_terminated", .member = &callback_registry::thread_terminated_cb},
            callback_slot{.name = "thread_set_name", .member = &callback_registry::thread_set_name_cb},
            callback_slot{.name = "thread_switch", .member = &callback_registry::thread_switch_cb},
        };
    }
