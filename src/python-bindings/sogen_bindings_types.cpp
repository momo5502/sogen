...
namespace sogen::py
{
    void register_types_bindings(nb::module_& m)
    {
        ...
        nb::enum_<x86_register>(m, "Register")
            ...
            .value("dr0", x86_register::dr0)
            .value("dr1", x86_register::dr1)
            .value("dr2", x86_register::dr2)
            .value("dr3", x86_register::dr3)
            .value("dr6", x86_register::dr6)
            .value("dr7", x86_register::dr7)
