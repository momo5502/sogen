...
void linux_syscall_dispatcher::add_handlers()
{
    ...
    this->handlers_[SYS_read] = {sys_read, "read"};
    this->handlers_[SYS_write] = {sys_write, "write"};
    this->handlers_[SYS_open] = {sys_open, "open"};
    this->handlers_[SYS_close] = {sys_close, "close"};
    this->handlers_[SYS_fstat] = {sys_fstat, "fstat"};
    ...
    this->handlers_[SYS_lstat] = {sys_lstat, "lstat"};
    this->handlers_[SYS_pread64] = {sys_pread64, "pread64"};
    this->handlers_[SYS_writev] = {sys_writev, "writev"};
    this->handlers_[SYS_dup] = {sys_dup, "dup"};
    this->handlers_[SYS_dup2] = {sys_dup2, "dup2"};
    this->handlers_[SYS_dup3] = {sys_dup3, "dup3"};
    this->handlers_[SYS_fcntl] = {sys_fcntl, "fcntl"};
    this->handlers_[SYS_ioctl] = {sys_ioctl, "ioctl"};
    this->handlers_[SYS_getcwd] = {sys_getcwd, "getcwd"};
    this->handlers_[SYS_readlink] = {sys_readlink, "readlink"};
    this->handlers_[SYS_readlinkat] = {sys_readlinkat, "readlinkat"};
    this->handlers_[SYS_getdents64] = {sys_getdents64, "getdents64"};
    this->handlers_[SYS_newfstatat] = {sys_newfstatat, "newfstatat"};

    // Memory syscalls
    this->handlers_[SYS_mmap] = {sys_mmap, "mmap"};
    this->handlers_[SYS_mprotect] = {sys_mprotect, "mprotect"};
    this->handlers_[SYS_munmap] = {sys_munmap, "munmap"};
    this->handlers_[SYS_brk] = {sys_brk, "brk"};

    // Process syscalls
    this->handlers_[SYS_exit] = {sys_exit, "exit"};
    this->handlers_[SYS_exit_group] = {sys_exit_group, "exit_group"};
    this->handlers_[SYS_uname] = {sys_uname, "uname"};
    this->handlers_[SYS_arch_prctl] = {sys_arch_prctl, "arch_prctl"};
    this->handlers_[SYS_prlimit64] = {sys_prlimit64, "prlimit64"};
    this->handlers_[SYS_rseq] = {sys_rseq, "rseq"};
    this->handlers_[SYS_getpid] = {sys_getpid, "getpid"};
    this->handlers_[SYS_getppid] = {sys_getppid, "getppid"};
    this->handlers_[SYS_getuid] = {sys_getuid, "getuid"};
    this->handlers_[SYS_getgid] = {sys_getgid, "getgid"};
    this->handlers_[SYS_geteuid] = {sys_geteuid, "geteuid"};
    this->handlers_[SYS_getegid] = {sys_getegid, "getegid"};
    this->handlers_[SYS_gettid] = {sys_gettid, "gettid"};
    this->handlers_[SYS_set_tid_address] = {sys_set_tid_address, "set_tid_address"};
    this->handlers_[SYS_set_robust_list] = {sys_set_robust_list, "set_robust_list"};
    this->handlers_[SYS_getrandom] = {sys_getrandom, "getrandom"};
    this->handlers_[SYS_rt_sigaction] = {sys_rt_sigaction, "rt_sigaction"};
    this->handlers_[SYS_rt_sigprocmask] = {sys_rt_sigprocmask, "rt_sigprocmask"};
    this->handlers_[SYS_sigaltstack] = {sys_sigaltstack, "sigaltstack"};

    // Memory syscalls (Tier 2)
    this->handlers_[SYS_mremap] = {sys_mremap, "mremap"};
    this->handlers_[SYS_madvise] = {sys_madvise, "madvise"};
    ...
    // I/O syscalls (Tier 2)
    this->handlers_[SYS_pipe] = {sys_pipe, "pipe"};
    this->handlers_[SYS_pipe2] = {sys_pipe2, "pipe2"};
    this->handlers_[SYS_eventfd] = {sys_eventfd, "eventfd"};
    this->handlers_[SYS_eventfd2] = {sys_eventfd2, "eventfd2"};

    // Threading syscalls (Tier 2)
    this->handlers_[SYS_clone] = {sys_clone, "clone"};
    this->handlers_[SYS_futex] = {sys_futex, "futex"};

    // File syscalls (Tier 3)
    this->handlers_[SYS_rename] = {sys_rename, "rename"};
    this->handlers_[SYS_renameat2] = {sys_renameat2, "renameat2"};
    this->handlers_[SYS_unlink] = {sys_unlink, "unlink"};
    this->handlers_[SYS_unlinkat] = {sys_unlinkat, "unlinkat"};
    this->handlers_[SYS_mkdir] = {sys_mkdir, "mkdir"};
    this->handlers_[SYS_mkdirat] = {sys_mkdirat, "mkdirat"};
    this->handlers_[SYS_rmdir] = {sys_rmdir, "rmdir"};
    this->handlers_[SYS_symlink] = {sys_symlink, "symlink"};
    this->handlers_[SYS_symlinkat] = {sys_symlinkat, "symlinkat"};
    this->handlers_[SYS_chmod] = {sys_chmod, "chmod"};
    this->handlers_[SYS_fchmod] = {sys_fchmod, "fchmod"};
    this->handlers_[SYS_fchmodat] = {sys_fchmodat, "fchmodat"};
    this->handlers_[SYS_chown] = {sys_chown, "chown"};
    this->handlers_[SYS_fchown] = {sys_fchown, "fchown"};
    this->handlers_[SYS_fchownat] = {sys_fchownat, "fchownat"};
    this->handlers_[SYS_truncate] = {sys_truncate, "truncate"};
    this->handlers_[SYS_ftruncate] = {sys_ftruncate, "ftruncate"};
    this->handlers_[SYS_pwrite64] = {sys_pwrite64, "pwrite64"};
    this->handlers_[SYS_readv] = {sys_readv, "readv"};
    this->handlers_[SYS_faccessat] = {sys_faccessat, "faccessat"};
    this->handlers_[SYS_statfs] = {sys_statfs, "statfs"};
    this->handlers_[SYS_fstatfs] = {sys_fstatfs, "fstatfs"};

    // Signal/process syscalls (Tier 3)
    this->handlers_[SYS_rt_sigreturn] = {sys_rt_sigreturn, "rt_sigreturn"};
    this->handlers_[SYS_kill] = {sys_kill, "kill"};
    this->handlers_[SYS_tgkill] = {sys_tgkill, "tgkill"};
    this->handlers_[SYS_wait4] = {sys_wait4, "wait4"};
    this->handlers_[SYS_execve] = {sys_execve, "execve"};
    this->handlers_[SYS_prctl] = {sys_prctl, "prctl"};
    this->handlers_[SYS_getrlimit] = {sys_getrlimit, "getrlimit"};
    this->handlers_[SYS_getrusage] = {sys_getrusage, "getrusage"};
    this->handlers_[SYS_sysinfo] = {sys_sysinfo, "sysinfo"};
    this->handlers_[SYS_umask] = {sys_umask, "umask"};
    this->handlers_[SYS_getpgrp] = {sys_getpgrp, "getpgrp"};
    this->handlers_[SYS_getpgid] = {sys_getpgid, "getpgid"};
    this->handlers_[SYS_setpgid] = {sys_setpgid, "setpgid"};
    this->handlers_[SYS_getsid] = {sys_getsid, "getsid"};
    this->handlers_[SYS_setsid] = {sys_setsid, "setsid"};

    // Socket syscalls (Tier 3)
    this->handlers_[SYS_socket] = {sys_socket, "socket"};
    this->handlers_[SYS_connect] = {sys_connect, "connect"};
    this->handlers_[SYS_accept] = {sys_accept, "accept"};
    this->handlers_[SYS_accept4] = {sys_accept4, "accept4"};
    this->handlers_[SYS_sendto] = {sys_sendto, "sendto"};
    this->handlers_[SYS_recvfrom] = {sys_recvfrom, "recvfrom"};
    this->handlers_[SYS_sendmsg] = {sys_sendmsg, "sendmsg"};
    this->handlers_[SYS_recvmsg] = {sys_recvmsg, "recvmsg"};
    this->handlers_[SYS_shutdown] = {sys_shutdown, "shutdown"};
    this->handlers_[SYS_bind] = {sys_bind, "bind"};
    this->handlers_[SYS_listen] = {sys_listen, "listen"};
    this->handlers_[SYS_setsockopt] = {sys_setsockopt, "setsockopt"};
    this->handlers_[SYS_getsockopt] = {sys_getsockopt, "getsockopt"};
    this->handlers_[SYS_socketpair] = {sys_socketpair, "socketpair"};
    this->handlers_[SYS_getsockname] = {sys_getsockname, "getsockname"};
    this->handlers_[SYS_getpeername] = {sys_getpeername, "getpeername"};

    // I/O multiplexing syscalls (Tier 3)
    this->handlers_[SYS_epoll_create1] = {sys_epoll_create1, "epoll_create1"};
    this->handlers_[SYS_epoll_ctl] = {sys_epoll_ctl, "epoll_ctl"};
    this->handlers_[SYS_epoll_wait] = {sys_epoll_wait, "epoll_wait"};
    this->handlers_[SYS_epoll_pwait] = {sys_epoll_pwait, "epoll_pwait"};
    this->handlers_[SYS_poll] = {sys_poll, "poll"};
    this->handlers_[SYS_ppoll] = {sys_ppoll, "ppoll"};
    this->handlers_[SYS_select] = {sys_select, "select"};
    this->handlers_[SYS_pselect6] = {sys_pselect6, "pselect6"};

    // Named but unimplemented syscalls (for better logging)
    this->handlers_[SYS_fork].name = "fork";
    this->handlers_[SYS_vfork].name = "vfork";
}
