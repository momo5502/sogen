...
#include "spinning_triangle_spirv.hxx"
...
int main(int argc, char** argv)
{
    ...
    const HWND hwnd =
        CreateWindowExA(0, wc.lpszClassName, "Sogen Vulkan - Spinning Triangle", window_style, 200, 200, static_cast<int>(window_width),
